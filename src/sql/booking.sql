...
-- Find the total number of rooms available in each hotel chain (Aggregation Query)
...
--Find the most expensive room in each hotel (Aggregation Query)
...
-- Find customers who have both booked and rented a room
